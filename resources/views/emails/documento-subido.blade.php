...
<body>
    <div class="container">
        ...
        <div class="body">
            <h2>Estimado/a {{ $documento->proyecto->cliente->nombre ?? 'Cliente' }},</h2>
            <p>Le informamos que se ha subido un nuevo documento a su proyecto <strong>{{ $documento->proyecto->nombre }}</strong>.</p>

            <div class="detalle">
                <p><strong>Documento:</strong> {{ $documento->nombre_original }}</p>
                <p><strong>Proyecto:</strong> {{ $documento->proyecto->nombre }}</p>
                <p><strong>Tamaño:</strong> {{ round($documento->tamano / 1024, 1) }} KB</p>
            </div>

            <p>El documento se adjunta a este correo para su revisión.</p>
            <p>Para consultas, contáctenos.</p>
